...
'''
  ...
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortA')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortB')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortC')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortD')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortE')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortF')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortG')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortH')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortI')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortJ')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortK')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortL')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortM')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortN')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortO')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'shortP')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayA')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayB')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayC')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayD')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayE')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayF')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayG')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayH')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayI')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayJ')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayK')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayL')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayM')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayN')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayO')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayP')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayQ')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayR')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayS')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayT')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayU')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayV')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayW')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayX')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'delayY')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'dscBuf')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'earlyA')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'earlyB')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'earlyC')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'earlyD')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'earlyE')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'earlyF')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'earlyG')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'earlyH')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'earlyI')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'vlfpredelay')
  out_contents = replace_class_local_identifier(out_contents, class_id, 'predelay')
